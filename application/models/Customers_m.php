...
class customers_m extends CI_Model {
    ...
    public function addcustomer($customer_name,$customer_phone,$secondary_phone,$email,$address,$customer_type_id) {
        $query = $this->db->query("INSERT INTO `customer_details`( `customer_type_id`, `phone_number`, `seconary_phone`, `first_name`,  `email_id`,  `address`) "
                . "VALUES ('$customer_type_id','$customer_phone','$secondary_phone','$customer_name','$email','$address')");
        return 1;
    }
